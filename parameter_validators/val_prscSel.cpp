...
)
{
	...
	try {
		...
		if ((val < static_cast<int>(0)) || (val > static_cast<int>(32))) {
			throw range_error{R"("prscSel" is out of range. [0-32])"};
		}

		v = boost::any(parameter::arg_types::PrscSel(val));
